...
export default function KitPage() {
  return (
    <div className="glass-card p-12 text-center text-sm text-text-secondary max-w-2xl mx-auto space-y-4 my-10">
      ...
      <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-4 text-xs italic">
