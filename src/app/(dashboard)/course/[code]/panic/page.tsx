...
export default function PanicPage() {
  return (
    <div className="rounded-xl border border-accent-panic/20 bg-accent-panic-glow/30 p-12 text-center text-sm text-text-secondary max-w-2xl mx-auto space-y-4 my-10 backdrop-blur-xl">
      ...
      <div className="rounded-lg border border-accent-panic/10 bg-brand-surface/40 p-4 text-xs font-semibold">
